/**
* DefaultEventStreamInterface.cpp
 *
 * History:
...
DefaultEventStreamInterface::DefaultEventStreamInterface() : EventStreamInterface(M_SERVER_MESSAGE_DOMAIN, true){ }

void DefaultEventStreamInterface::handleEvent(shared_ptr <Event> evt) {
...
void DefaultEventStreamInterface::handleSystemEvent(const Datum &sysEvent) {
