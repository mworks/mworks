...
ControlEventHandler::ControlEventHandler() : EventStreamInterface(M_SERVER_MESSAGE_DOMAIN, true){ }

void ControlEventHandler::handleEvent(shared_ptr <Event> evt) {
...
void ControlEventHandler::handleSystemEvent(const Datum &sysEvent) {
