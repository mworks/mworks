...
@interface NSObject (NRTPlotDataSourceInformalProtocol)
...
// Returns a superset of those indexes contained in the variable ranges passed.
-(NSArray *)dataClusterIndexesForPlot:(NRTPlot *)plot betweenLowerBounds:(NSArray *)lowerBounds
    andUpperBounds:(NSArray *)upperBounds;
