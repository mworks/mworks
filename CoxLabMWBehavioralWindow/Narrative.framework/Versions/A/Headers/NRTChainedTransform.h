//
//  NRTChainedTransform.h
//  Narrative
//
//  Allows you to chain several transforms together. They get applied
//  one after the other to any coordinates.
//
...
@interface NRTChainedTransform : NRTCompositeTransform {
