...
ComponentRegistry::ComponentRegistry() {
    ...
    registerFactory<StandardComponentFactory, LoadStimulus>();
    registerFactory<StandardComponentFactory, UnloadStimulus>();
    registerFactory<StandardComponentFactory, QueueStimulus>();
    registerFactoryAlias<QueueStimulus>("action/show_stimulus");
    registerFactory<StandardComponentFactory, LiveQueueStimulus>();
    registerFactory<StandardComponentFactory, DequeueStimulus>();
    registerFactoryAlias<DequeueStimulus>("action/hide_stimulus");
    registerFactory<StandardComponentFactory, BringStimulusToFront>();
    registerFactory<StandardComponentFactory, SendStimulusToBack>();
