...
void VariableRegistryTestFixture::testCodec(){
	...
	checkCodec(generated_codec.toScarabDatum().get(), 0);
	...
	checkCodec(generated_codec2.toScarabDatum().get(), n_variables);
	...
	checkCodec(generated_codec3.toScarabDatum().get(), 1);
	...
	checkCodec(generated_codec4.toScarabDatum().get(), 2);
