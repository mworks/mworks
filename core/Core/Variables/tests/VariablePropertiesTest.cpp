...
void VariablePropertiesTestFixture::setUp(){
	...
	registry = shared_ptr<VariableRegistry>(new VariableRegistry(global_outgoing_event_buffer));
}
...
void VariablePropertiesTestFixture::testGroups(){
	...
	shared_ptr <Variable> v0 = registry->createGlobalVariable( VariableProperties(Datum((long)0),
																						"v0", 
																						"v0", 
																						"the var 0", 
																						M_WHEN_CHANGED,
	...
	shared_ptr <Variable> v1 = registry->createGlobalVariable( VariableProperties(Datum((long)0), 
																						"v1", 
																						"v1", 
																						"the var 1", 
																						M_WHEN_CHANGED,
	...
	shared_ptr <Variable> v2 = registry->createGlobalVariable( VariableProperties(Datum((long)0), 
																						"v2", 
																						"v2", 
																						"the var 2", 
																						M_WHEN_CHANGED,
	...
	shared_ptr <Variable> v2point5 = registry->createGlobalVariable( VariableProperties(Datum((long)0), 
																						"v2point5", 
																						"v2point5", 
																						"the var 2.5", 
																						M_WHEN_CHANGED,
	...
	shared_ptr <Variable> v3 = registry->createGlobalVariable( VariableProperties(Datum((long)0), 
																						"v3", 
																						"v3", 
																						"the var 3", 
																						M_WHEN_CHANGED,
	...
	shared_ptr <Variable> v3point5 = registry->createGlobalVariable( VariableProperties(Datum((long)0), 
																						"v3.5", 
																						"v3.5", 
																						"the var 3.5", 
																						M_WHEN_CHANGED,
	...
	shared_ptr <Variable> v4 = registry->createGlobalVariable( VariableProperties(Datum((long)0), 
																						"v4", 
																						"v4", 
																						"the var 4", 
																						M_WHEN_CHANGED,
	...
	shared_ptr <Variable> v5 = registry->createGlobalVariable( VariableProperties(Datum((long)0), 
																						"v5", 
																						"v5", 
																						"the var 5", 
																						M_WHEN_CHANGED,
