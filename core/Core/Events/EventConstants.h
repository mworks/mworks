...
#define MWORKS_PAYLOAD_EVENT_N_TOPLEVEL_ELEMENTS	3
#define MWORKS_EVENT_N_TOPLEVEL_ELEMENTS			2

#define MWORKS_EVENT_CODEC_CODE_INDEX	0
#define MWORKS_EVENT_TIME_INDEX			1
#define MWORKS_EVENT_PAYLOAD_INDEX		2
