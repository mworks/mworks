...
//    char *formatstring = "use lib '%s'; use lib '/sw/lib/perl5'; use lib '/sw/lib/perl5/darwin'; use lib '/sw/lib/perl/5.8.1/darwin-thread-multi-2level'; use MonkeyScript; use FileHandle; use English; $command = qq(%s); $command =~ s{=\\s+new\\s+m}{= new MonkeyScript\:\:m}sg; eval($command); if($EVAL_ERROR){ mprintf(qq(Perl Interpreter Error: $EVAL_ERROR));  printf(qq(Perl Interpreter Error: $EVAL_ERROR)); mprintf(qq(Command was: $command)); }";
    #if __darwin__
	    char *formatstring = "use lib '%s'; use lib '/Library/MWorks'; use lib '/Library/MWorks/lib; use lib '/Library/MWorks/lib/perl5/5.8.8/darwin-thread-multi-2level/'; use lib '/Library/MWorks/lib/perl5/site_perl/5.8.8/darwin-thread-multi-2level/'; use lib '/Library/MWorks/lib/perl5/site_perl/5.8.8/darwin-thread-multi-2level/auto'; use MonkeyScript; use FileHandle; use English; $command = qq(%s); $command =~ s{=\\s+new\\s+m}{= new MonkeyScript\:\:m}sg; eval($command); if($EVAL_ERROR){ mprintf(qq(Perl Interpreter Error: $EVAL_ERROR));  printf(qq(Perl Interpreter Error: $EVAL_ERROR)); mprintf(qq(Command was: $command)); }";
    #else
