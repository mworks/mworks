...
@interface TwoLineImageTextCell : NSTextFieldCell {
	NSObject* delegate;
...
@interface NSObject(TwoLineImageTextCellDelegate)
...
- (NSObject*) dataElementForCell: (TwoLineImageTextCell*) cell;

// optional
- (BOOL) disabledForCell: (TwoLineImageTextCell*) cell data: (NSObject*) data;
