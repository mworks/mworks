//
//  NRTIrreducibleTransform.h
//  Narrative
//
//  This represents a transform which cannot be decomposed into other transforms.
//
...
@interface NRTIrreducibleTransform : NRTTransform {
    NSArray *_baseCoordinateIdentifiers;
    NSArray *_transformedCoordinateIdentifiers;
}
