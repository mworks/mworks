//
//  NRTOrthogonalTransform.h
//  Narrative
//
//  This is a NRTCompositeTransform in which the various component
//  transforms are orthogonal, or independent of one another. An example
...
@interface NRTOrthogonalTransform : NRTCompositeTransform {
