...
def get_plugins(**kwargs):
    ...
    builder_name = "standard_core_plugins"    
    ...
    core_plugins_factory.addStep(source.Git(repository_base_url + "mw_core_plugins.git", current_branch, mode=checkout_type))
    ...
    # ========================
    # Standard Client Plugins
    # ========================
    
    builder_name = "standard_client_plugins"    
    ...
    client_plugins_factory.addStep(source.Git(repository_base_url + "mw_client_plugins.git", current_branch, mode=checkout_type))
